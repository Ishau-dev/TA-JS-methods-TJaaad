...
*/
let quotedSplitted= quote.split(' ');
/*
...
*/
quotedSplitted[quotedSplitted.length-1].indexOf('o', quotedSplitted[quotedSplitted.length-1].indexOf('o')+1)
/*
...
*/
quote.indexOf('a', quote.indexOf('a')+1);
/*
